...
export const appThemes: readonly ThemeDefinition[] = [
  ...
  createTheme(
    ...
    "oklch(0.583 0.193 253)",
    {
      ...
      primary: "oklch(0.583 0.193 253)",
      "primary-foreground": "oklch(1 0 0)",
      secondary: "oklch(0.97 0.005 247)",
      "secondary-foreground": "oklch(0.22 0 0)",
      muted: "oklch(0.97 0.005 247)",
      "muted-foreground": "oklch(0.55 0.005 247)",
      accent: "oklch(0.95 0.01 247)",
      "accent-foreground": "oklch(0.22 0 0)",
      destructive: "oklch(0.629 0.234 28)",
      "destructive-foreground": "oklch(1 0 0)",
      success: "oklch(0.749 0.184 145)",
      "success-foreground": "oklch(1 0 0)",
      warning: "oklch(0.749 0.169 65)",
      "warning-foreground": "oklch(0.22 0 0)",
      info: "oklch(0.583 0.193 253)",
      "info-foreground": "oklch(1 0 0)",
      border: "oklch(0.92 0.004 247)",
      input: "oklch(0.92 0.004 247)",
      ring: "oklch(0.583 0.193 253 / 0.4)",
      "chart-1": "oklch(0.583 0.193 253)",
      "chart-2": "oklch(0.749 0.184 145)",
      "chart-3": "oklch(0.749 0.169 65)",
      "chart-4": "oklch(0.629 0.234 28)",
      "chart-5": "oklch(0.605 0.226 308)",
      sidebar: "oklch(0.97 0.005 247)",
      "sidebar-foreground": "oklch(0.22 0 0)",
      "sidebar-primary": "oklch(0.583 0.193 253)",
      "sidebar-primary-foreground": "oklch(1 0 0)",
      "sidebar-accent": "oklch(0.93 0.005 247)",
      "sidebar-accent-foreground": "oklch(0.22 0 0)",
      "sidebar-border": "oklch(0.92 0.004 247)",
      "sidebar-ring": "oklch(0.583 0.193 253 / 0.4)",
      "theme-font-sans":
        "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'SF Pro Text', 'Helvetica Neue', Helvetica, Arial, sans-serif",
      "theme-font-serif": "'New York', ui-serif, Georgia, serif",
      "theme-font-mono":
        "ui-monospace, 'SF Mono', SFMono-Regular, Menlo, Monaco, Consolas, monospace",
      radius: "0.625rem",
      "theme-tracking-normal": "-0.011em",
      "theme-icon-stroke-width": "1.7",
      "theme-icon-accent-mix": "10%",
      "theme-icon-chip-shadow":
        "0 12px 24px -16px hsl(220 8% 12% / 0.18)",
      "theme-shadow-2xs": "0 1px 1px 0 hsl(220 8% 12% / 0.04)",
      "theme-shadow-xs": "0 1px 2px 0 hsl(220 8% 12% / 0.05)",
      "theme-shadow-sm":
        "0 1px 2px 0 hsl(220 8% 12% / 0.06), 0 1px 1px -1px hsl(220 8% 12% / 0.05)",
      "theme-shadow":
        "0 2px 4px -2px hsl(220 8% 12% / 0.08), 0 1px 2px -1px hsl(220 8% 12% / 0.05)",
      "theme-shadow-md":
        "0 4px 8px -4px hsl(220 8% 12% / 0.10), 0 2px 4px -2px hsl(220 8% 12% / 0.06)",
      "theme-shadow-lg":
        "0 12px 24px -8px hsl(220 8% 12% / 0.14), 0 4px 8px -4px hsl(220 8% 12% / 0.08)",
      "theme-shadow-xl": "0 20px 40px -12px hsl(220 8% 12% / 0.18)",
      "theme-shadow-2xl": "0 32px 64px -24px hsl(220 8% 12% / 0.24)",
    },
  ),
  createTheme(
    "darkmatter",
